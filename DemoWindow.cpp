...
void DemoWindow::draw_cube()
{
	...
	glColor3d(1.0, 0.8, 0.8);		// Нижняя грань, розовая
	glVertex3d(-1.0,  1.0, -1.0);
	glVertex3d( 1.0,  1.0, -1.0);
	glVertex3d( 1.0, -1.0, -1.0);
	glVertex3d(-1.0, -1.0, -1.0);

	glColor3d(0.5, 0.5, 0.5);		// Верхняя грань, серая
	glVertex3d(-1.0, -1.0,  1.0);
	glVertex3d( 1.0, -1.0,  1.0);
	glVertex3d( 1.0,  1.0,  1.0);
	glVertex3d(-1.0,  1.0,  1.0);
	...
	glColor3d(0.5, 0.0, 1.0);		// Задняя грань, фиолетовая
	glVertex3d(-1.0,  1.0,  1.0);
	glVertex3d(-1.0, -1.0,  1.0);
	glVertex3d(-1.0, -1.0, -1.0);
	glVertex3d(-1.0,  1.0, -1.0);
...
void DemoWindow::draw_space()
{
	...
	glColor3d(0.8, 0.1, 0.1);		// Нижняя грань, красная
	glVertex3d( 0.0,  1.0,  0.0);
	glVertex3d( 1.0,  1.0,  0.0);
	glVertex3d( 1.0,  0.0,  0.0);
	glVertex3d( 0.0,  0.0,  0.0);

	glColor3d(0.7, 0.5, 0.2);		// Верхняя грань, оранжевая
